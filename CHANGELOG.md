...
## v1.34.0 (b5f0993) — 2026-07-02

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 일정을 기간(여러 날)으로 등록 | b5f0993 |

## v1.33.1 (484a5d5) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 | 날짜 바로가기 컨트롤을 화면 중앙 모달로 배치 | 484a5d5 |

## v1.33.0 (626f0ae) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 년·월·일 바로가기 추가 | 626f0ae |

## v1.32.2 (c5ecba1) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 | 앱 시작 시 하단 탭바가 화면 하단에 딱 붙도록 수정 | c5ecba1 |

## v1.32.1 (52b48bb) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 | 캘린더 헤더 2행 배치 + 플로팅 챗 버튼 위치 최적화 | 52b48bb |

## v1.32.0 (16ffaee) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | AI 일정 최적화 + 시간 보호 | 16ffaee |

## v1.31.0 (4d5e9ed) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 자연어로 일정·할일 빠른 추가 | 4d5e9ed |

## v1.30.0 (ebb6c75) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 일정·할일 다른 사용자 전달(받는 사람 자동 추가) + 검색 정렬 | ebb6c75 |

## v1.29.0 (142f0f8) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 일정·할일 전체 목록 보기 및 검색 패널 추가 | 142f0f8 |

## v1.28.0 (bdaf8f2) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 브레인덤프·Top3·메모를 서버에 저장 (기기 종속 제거) | bdaf8f2 |

## v1.27.0 (dbe43ed) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 음성 전사 — 녹음을 AI로 텍스트 전사 (Phase 4) | dbe43ed |

## v1.26.0 (a3aa98d) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 앱 연동 — 메모를 할일/리마인더/일정으로 변환 (Phase 3) | a3aa98d |

## v1.25.0 (dc646f9) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 편집 강화 — 체크리스트/자동저장/전체화면 + iOS 녹음 안내 (Phase 2) | dc646f9 |

## v1.24.0 (a86de94) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 정리/구성 — 색상 라벨 + 타입 필터 + 정렬 (Phase 1) | a86de94 |

## v1.23.0 (28bafcd) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 검색 키워드 하이라이트 | 28bafcd |

## v1.22.0 (f02bda0) — 2026-07-01

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 검색 + AI 요약 + 다른 사용자에게 전달 | f02bda0 |

## v1.21.0 (36c9577) — 2026-06-30

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 삭제 확인 + 휴지통(소프트 삭제/복원/영구삭제) | 36c9577 |

## v1.20.0 (7737ea1) — 2026-06-29

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 본문 입력창 자동 높이 + 카드 전체 줄 표시 + iOS 녹음 견고화 | 49ba4fa |

## v1.19.4 (49ba4fa) — 2026-06-29

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 개선 | 노트 작성/수정 입력창이 입력 줄 수에 따라 자동 높이 조절 | 49ba4fa |
| ✨ 개선 | 저장된 노트 카드에서 본문 전체 줄 표시 (line-clamp 제거) | 49ba4fa |
| 🐛 수정 | iOS 녹음 견고화 — 실제 오류 노출 + 마지막 청크 플러시 + start 폴백 | 49ba4fa |

## v1.19.3 (9324399) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 | iOS 음성 재생 안정화 — 서버 직접 스트리밍 + 녹음 견고화 | 9324399 |

## v1.19.2 (2e10dc0) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 | 덤프 항목 재스케줄 시 시간별 사본 생성되던 문제 수정 | 2e10dc0 |

## v1.19.1 (b420545) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 | 음성 메모 재생 안 되던 문제(포맷/확장자 불일치) 수정 | b420545 |

## v1.19.0 (fb09bee) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 음성녹음 메모 + 손글씨 메모 추가 (2단계) | fb09bee |

## v1.18.0 (7c71f5b) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 기능 추가 — 새 탭 + 서버 저장 | 7c71f5b |

## v1.17.0 (2a0433a) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 |  | 2a0433a |

## v1.16.0 (6cd2392) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 브레인 덤프 항목 완료 처리 | 6cd2392 |

## v1.15.0 (53833d7) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 | 시간 입력 겹침 수정 + 타임테이블 드래그를 수정 모드에서만 동작 | 53833d7 |

## v1.14.1 (3638211) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 |  | 3638211 |

## v1.14.0 (a059d4a) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 |  | a059d4a |

## v1.13.1 (a506f1e) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 | 데이터 자동 생성 제거 | a506f1e |

## v1.13.0 (94c41f7) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| ✨ 기능 |  | 94c41f7 |

## v1.12.0 (e5f5dc5) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 | 방지 | e5f5dc5 |

## v1.11.5 (21b59fb) — 2026-06-28

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 |  | 21b59fb |

## v1.11.3 (191eec8) — 2026-05-22

| 항목 | 설명 | 커밋 |
|------|------|------|
| 🐛 수정 |  | 191eec8 |

## v1.11.2 (febd712) — 2026-05-22
