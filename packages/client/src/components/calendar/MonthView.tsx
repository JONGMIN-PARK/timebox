              ...
              <div className="divide-y divide-slate-100 dark:divide-slate-700/30">
                ...
                {selectedDateEvents.map((ev) => (
                  <div key={`ev-${ev.id}`} className="group flex items-center gap-3 px-4 py-2.5 hover:bg-blue-50/50 dark:hover:bg-slate-700/40 transition-colors">
                    ...
                    <button onClick={() => onDeleteEvent(ev.id)} className="opacity-0 group-hover:opacity-100 p-1 rounded hover:bg-red-50 dark:hover:bg-red-900/20 transition-all">
                ...
                {selectedDateTodos.map((td) => (
                  <div key={`td-${td.id}`} className="flex items-center gap-3 px-4 py-2.5 hover:bg-amber-50/30 dark:hover:bg-slate-700/40 transition-colors">
