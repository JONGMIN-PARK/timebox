...
export default function MobileNav({ activeTab, onTabChange }: MobileNavProps) {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/90 dark:bg-slate-800/95 backdrop-blur-lg border-t border-slate-200/60 dark:border-slate-700/40 z-40 pb-[env(safe-area-inset-bottom,0px)]">
